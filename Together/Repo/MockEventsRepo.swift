...
final class MockEventsRepo {
    ...
    private init() {
        ...
        events.append(Event(id: 4, title: "Помощь с покупками в магазине",
        ...
        events.append(Event(id: 5, title: "Купить Медикоменты",
        ...
        events.append(Event(id: 6, title: "Купить Матрац",
